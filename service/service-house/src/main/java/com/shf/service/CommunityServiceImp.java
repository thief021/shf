...
import com.shf.dao.CommunityDao;
...
@Transactional
public class CommunityServiceImp extends BaseSeriviceImp<Community> implements CommunityService{
    @Autowired
    ...
    public Community getById(Serializable id) {
        ...
        Community community = (Community) communityDao.getById(id);
        if(community == null){
            return null;
        }
        //根据区域的id获取区域的名字
